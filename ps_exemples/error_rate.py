...
f.write('ngram : ' + wer['ngram'] + '\n')
f.write('jsgf_seq_135 : ' + wer['jsgf_seq_135'] + '\n')
f.write('jsgf_seq_unknown : ' + wer['jsgf_seq_unknown'] + '\n\n\n' )

f.write('--- SPEAKER GROUP COMPARAISON (all very low noise with all digits sequence) ---\n')
f.write('girl : ' + wer['girl'] + '\n')
f.write('man : ' + wer['man'] + '\n')
f.write('woman : ' + wer['woman'] + '\n' )
f.write('boy : ' + wer['boy'] + '\n\n\n' )

f.write('---  LENGTH COMPARAISON (all very low noise only for man) ---\n')
f.write('one_digit : ' + wer['one_digit'] + '\n')
f.write('three_digit : ' + wer['three_digit'] + '\n')
f.write('five_digit : ' + wer['five_digit'] + '\n\n\n' )

f.write('--- NOISE COMPARAISON (only man speakers) ---\n')
f.write('man_high_q : ' + wer['man_high_q'] + '\n')
f.write('man_standard_q : ' + wer['man_standard_q'] + '\n')
f.write('man_low_q : ' + wer['man_low_q'] + '\n' )
f.write('man_very_low_q : ' + wer['man_very_low_q'] + '\n\n\n' )
